    ...
    <div className="mt-3">
      ...
      <div className="mt-2">
        {course?.courseOutput?.chapters.map((chapter, index) => (
          <div className="border rounded-lg p-5 mb-2 flex items-center justify-between">
            <div className="flex gap-5 items-center">
              <h2 className="bg-primary flex-none h-10 w-15 text-white rounded-full text-center p-2">
                {index + 1}
              </h2>
              <div>
